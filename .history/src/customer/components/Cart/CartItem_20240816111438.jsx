...
const CartItem = ({ initialQuantity }) => {
    ...
    const [isDeleted, setIsDeleted] = useState(false); // Thêm trạng thái để theo dõi việc xóa
    ...
    const handleDelete = () => {
        setIsDeleted(true); // Đặt trạng thái là đã xóa
    };
