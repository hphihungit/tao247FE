                    ...
                    <div className='border'>
                        ...
                        <div className='space-y-3 font-semibold mb-10'>
                            <div className='flex justify-between pt-3'>
                                ...
                                <span className='text-red-500'>{cart.cart?.totalBeforePrice}</span>
                            </div>
                            <div className='flex justify-between pt-3 '>
                                <span>Khuyến mãi</span>
                                <span className='text-red-500'>{cart.cart?.totalDiscount}</span>
                            </div>
                            <div className='flex justify-between pt-3 '>
                                <span>Phí vận chuyển</span>
                                <span className='text-red-500'>Miễn p</span>
                            </div>
