...
export const findProducts = (reqData) => async (dispatch) => {
    ...
    try {
        const {data} = await api.get(`/api/products?capacity=${capacity}&minPrice=${minPrice}&maxPrice=${maxPrice}&category=${category}&stock=${stock}&sort=${sort}&pageNumber=${pageNumber}&pageSize=${pageSize}`)
